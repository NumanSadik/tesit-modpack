...
craftingTable.removeByName("malum:charcoal_fragment");
craftingTable.removeByName("malum:coal_fragment");
...
craftingTable.addShaped("bench", <item:meadow:bench>, [[<item:minecraft:air>], [<tag:items:minecraft:wooden_slabs>,<tag:items:minecraft:wooden_slabs>,<tag:items:minecraft:wooden_slabs>], [<item:minecraft:stick>, <item:minecraft:air>, <item:minecraft:stick>]]);
...
craftingTable.removeByName("meadow:pine_beam");
craftingTable.addShaped("pine_beam", <item:meadow:pine_beam>*3, [[<item:minecraft:air>, <item:meadow:pine_log>], [<item:minecraft:air>, <item:meadow:pine_log>]]);
...
craftingTable.removeByName("brewery:rope");
craftingTable.addShaped("rope", <item:brewery:rope>, [[<item:minecraft:string>, <tag:items:forge:crops/barley>, <item:minecraft:string>]]);
...
craftingTable.removeByName("wares:cardboard_box");
craftingTable.addShaped("cardboard_box", <item:wares:cardboard_box>*3, [[<item:minecraft:air>],[<item:minecraft:paper>, <item:minecraft:paper>, <item:minecraft:paper>], [<item:minecraft:paper>, <item:minecraft:paper>, <item:minecraft:paper>]]);
...
<tagmanager:items>.addId(<tag:items:minecraft:compasses>, [<resource:spelunkery:magnetic_compass>, <resource:piglinproliferation:travelers_compass>]);
...
<tagmanager:items>.addId(<tag:items:supplementaries:straw>, <resource:thermal:flax>);
<tagmanager:items>.addId(<tag:items:minecraft:straw>, <resource:thermal:flax>);
<tagmanager:items>.addId(<tag:items:forge:berries>, <resource:thermal:strawberry>);
<tagmanager:items>.addId(<tag:items:forge:strawberry>, <resource:thermal:strawberry>);
<tagmanager:items>.addId(<tag:items:farm_and_charm:strawberries>, <resource:thermal:strawberry>);
<tagmanager:items>.addId(<tag:items:c:strawberry>, <resource:thermal:strawberry>);
<tagmanager:items>.addId(<tag:items:c:strawberries>, <resource:thermal:strawberry>);
<tagmanager:items>.addId(<tag:items:farm_and_charm:vegetables>, <resource:thermal:tomato>);
<tagmanager:items>.addId(<tag:items:forge:vegetables>, <resource:thermal:tomato>);
<tagmanager:items>.addId(<tag:items:forge:vegetables/tomato>, <resource:thermal:tomato>);
...
<tagmanager:items>.addId(<tag:items:c:crops/barley>, <resource:thermal:barley>);
...
<tagmanager:blocks>.addId(<tag:blocks:spelunkery:salt_blocks>, [<resource:vintagedelight:salt>, <resource:vintagedelight:salt_block>, <resource:salt:salt_block>]);
<tagmanager:blocks>.addId(<tag:blocks:forge:storage_blocks>, [<resource:vintagedelight:salt_block>, <resource:salt:salt_block>, <resource:spelunkery:salt_block>]);
<tagmanager:blocks>.addId(<tag:blocks:forge:storage_blocks/salt>, [<resource:vintagedelight:salt_block>, <resource:salt:salt_block>, <resource:spelunkery:salt_block>]);
