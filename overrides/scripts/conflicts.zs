...
<tagmanager:items>.addId(<tag:items:forge:helmets>, [<resource:galosphere:sterling_helmet>, <resource:pneumaticcraft:compressed_iron_helmet>, <resource:pneumaticcraft:pneumatic_helmet>, <resource:thermal:beekeeper_helmet>, <resource:thermal:diving_helmet>, <resource:thermal:hazmat_helmet>, <resource:candlelight:cooking_hat>, <resource:vinery:straw_hat>, <resource:brewery:brewfest_hat>, <resource:brewery:brewfest_hat_red>]);
<tagmanager:items>.addId(<tag:items:forge:chestplates>, [<resource:galosphere:sterling_chestplate>, <resource:pneumaticcraft:compressed_iron_chestplate>, <resource:pneumaticcraft:pneumatic_chestplate>, <resource:thermal:beekeeper_chestplate>, <resource:thermal:diving_chestplate>, <resource:thermal:hazmat_chestplate>, <resource:candlelight:chefs_jacket>, <resource:vinery:winemaker_apron>, <resource:brewery:brewfest_regalia>, <resource:brewery:brewfest_blouse>]);
<tagmanager:items>.addId(<tag:items:forge:leggings>, [<resource:galosphere:sterling_leggings>, <resource:pneumaticcraft:compressed_iron_leggings>, <resource:pneumaticcraft:pneumatic_leggings>, <resource:thermal:beekeeper_leggings>, <resource:thermal:diving_leggings>, <resource:thermal:hazmat_leggings>, <resource:candlelight:chefs_pants>, <resource:vinery:winemaker_leggings>, <resource:brewery:brewfest_trousers>, <resource:brewery:brewfest_dress>]);
